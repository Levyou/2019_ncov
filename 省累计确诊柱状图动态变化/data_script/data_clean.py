#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/2/22 0022 10:07
# @Author  : y
# 本脚本是针对中国新冠病毒各省市历史发病数据的清洗工具
# 原作者 https://github.com/Avens666  mail: cz_666@qq.com
...
input_file = "data.csv"  # "t15.csv"
output_file = "out2_21.csv"
...
out.to_csv(output_file, encoding="utf_8_sig")  # 为保证excel打开兼容，输出为UTF8带签名格式
print('done!')